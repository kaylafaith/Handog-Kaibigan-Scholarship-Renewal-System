...
if(isset($_POST['loginbutton'])){
    ...
    if ($username != "" && $password != ""){
        ...
        $sql_query = "select count(*) as cntUser from tbl_students where student_number='".$username."'and BINARY password='".$password."'";
...
<div class="login-form">
    <form action="" method="post">
        <h2 class="text-center">Sign in as STUDENT</h2> 
