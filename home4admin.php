								...
								<nav class="navbar navbar-default">
									<div class="navbar-collapse">
										...
										<ul id="nav" class="nav menu navbar-nav">
											...
											<li><a href="message4admin1.php"><i class="fa fa-clone"></i>Messages</a>
											<li><a href="signup.php"><i class="fa fa-clone"></i>Profile</a></li>
											<li><a href="#"><i class="fa fa-clone"></i>List Of Scholars</a>
											</li>
						...
						<div class="row">
							<div class="col-lg-7 col-md-10 col-12">
								...
								<div class="slider-content">
									...
									<!-- Button -->
									<div class="button">
										<a href="courses.html" class="btn white primary">Open Form</a>
										<a href="courses.html" class="btn white primary">Close Form</a>
									</div>
									<!--/ End Button -->
								</div>
								<!--/ End Slider Content -->
