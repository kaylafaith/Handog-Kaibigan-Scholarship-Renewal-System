...
if(isset($_POST['loginbutton'])){
    ...
    if ($username != "" && $password != ""){
        ...
        $sql_query = "select count(*) as cntUser from tbl_students where student_number='".$username."' and first_name='".$firstname."' and last_name='".$lastname."' and password='".$password."'";
